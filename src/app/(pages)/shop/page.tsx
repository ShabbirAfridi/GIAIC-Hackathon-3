  ...
  return (
    <div>
      ...
      <div className="flex items-center bg4-center bg4-cover h-[320px] flex-col justify-center bg-[url('/images/shopbg.png')] bg-cover">
        <Image src="/icons/shop1.png" height={70} width={70} alt="Shop Icon" />
      ...
      <div className="flex justify-between items-center h-[70px] px-4 lg:px-10 bg-cream2">
        <div className="flex-row gap-3 h-[50px] flex items-center">
          ...
          {/* View Toggle */}
          <button onClick={() => setIsGridView(true)} aria-label="Grid View">
            <Image
              src="/icons/four.png"
              width={18}
              height={18}
          ...
          <button onClick={() => setIsGridView(false)} aria-label="List View">
            <Image
              src="/icons/view.png"
              width={18}
              height={18}
            ...
            {displayedProducts.map((product) => (
              ...
              >
                <Image
                  ...
                  alt={product.name}
                  width={isGridView ? 256 : 128}
                  height={isGridView ? 256 : 128}
                  className={`${
